...
execute: async (client, message, args) => {
    ...
    await Banco.agregar(user.id, message.guild.id, cantidad)//AÑADIMOS EL DINERO EL DINERO
    message.channel.send(`Se le ha agregado ${cantidad} a ${user.username}`)//ENVIAMOS MENSAJE QUE TODO SALIO BIEN
